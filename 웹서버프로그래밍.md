...
http://localhost:8080/wed/main.jsp#

구성: 메인페이지, 로그인페이지, 회원 조회 페이지, 모델 추가, 사진 업로드, 사진페이지
데이터베이스: 페이지 회원데이터 구성![LOG1](https://user-images.githubusercontent.com/105197503/205261330-463e2e87-c059-4eff-a170-06d5b2e91f57.png)
...
https://2-juhyun-2.tistory.com/133
...
<body>
	<div id="page">
		<header>
			<div id="logo">
				<img src="https://user-images.githubusercontent.com/105197503/205237643-110b746f-41c9-4cf2-a46a-2b8d5c316489.jpg" alt="logo">
			</div>
		...
		<article id="content">
			<section id="main">
				<li><a href="#"></a><img src="https://user-images.githubusercontent.com/105197503/205238152-da6b60d8-a60e-484d-8dd2-3f578585cea5.png" alt="log2"></a></li>
			</section>
		</article>
	</div>
</body>
