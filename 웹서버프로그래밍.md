...
https://peterkimlab.github.io/jsp/JSP-%EA%B2%8C%EC%8B%9C%ED%8C%90-%EC%9B%B9-%EC%82%AC%EC%9D%B4%ED%8A%B8-%EB%A7%8C%EB%93%A4%EA%B8%B0/

https://github.com/peterkimlab/BulletinBoardSystem
...
<body>
	...
	<nav class="navbar navbar-default">
		<div class="navbar-header">
			...
			<a class="navbar-brand" href="main.jsp">JSP 웹서버프로그래밍 웹사이트</a>
		</div>
	...
	<script src="http://code.jpuery.com/jpuery-3.1.1.min.js"></script>
